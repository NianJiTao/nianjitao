...
namespace NJT.Core
{
    public class 时钟配置
    {
        ...
        [XmlIgnore]
        public FontFamily 时间字体 { get; set; } = new FontFamily("微软雅黑");
        ...
        [XmlIgnore]
        public SolidColorBrush 时间颜色 { get; set; } = Brushes.DarkGreen;

        [XmlIgnore]
        public SolidColorBrush 日期颜色 { get; set; } = Brushes.DarkGreen;

        [XmlIgnore]
        public SolidColorBrush 星期颜色 { get; set; } = Brushes.DarkGreen;

        [XmlIgnore]
        public SolidColorBrush 背景颜色 { get; set; } = Brushes.LightSteelBlue;
